...
const ch = 
{
		...
		front:'首页',
        secondFPartT:'公司',
        secondFPartCF:'Point 95 Global 是一所数字资产管理公司，专门从事数字资产量化交易，并坚持以提供业内“最优级”数字资产投资工具作为目标。',
        secondFPartCL:'Point 95 Global通过使用海量的数据验证而形成的独有的量化投资策略，做到在不断变化的数字资本市场中搜索和筛选投资机会。  ',
        secondSPartT:'策略',
        secondSPartC:'Point95 Global采用低风险的量化交易策略，在动荡的数字资本市场中确保持续和稳定的alpha收益。',
        thirdPartT:'做市商',
        thirdPartC:'Point95 Global致力于提供做市商服务，其中包括提供流动性、稳定价格、防止恶意市场操纵行为和进行套利交易。多年来，我们凭借着专有的做市商模型在复杂的传统金融市场中做出了杰出的表现。与此同时，在数字资产市场中的做市商服务成效也被证明是出类拔萃的。我们做市商服务的客户通常为交易所和ICO项目方。',
        fourthPartTTF:'团',
        fourthPartTTL:'队',
